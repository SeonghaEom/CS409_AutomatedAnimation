...
def back_light2_effect (cap, frame, back_cap, back_frame, out, in_video, effect_path, i) :
   
    eff_path = effect_path + '/back/light2.mp4'
    ...
    while(cap.isOpened()):
        ...
        if start <= i < start+n :
            ...
            if i%8<4 and i>start+rand_num and i<start+rand_num+30:
